...
<head>
    ...
    <link rel="shortcut icon" href="https://metropolys.ovh/aps_social.png" type="image/vnd.microsoft.icon">
    <style type="text/css">
    ...
    <link rel="shortcut icon" type="image/x-icon" href="https://images.habbo.com/habbo-web/america/pt/assets/images/favicon.08c747be.ico">
    ...
    <link rel="stylesheet" href="<?php echo url ?>/structure/files/tema/<?php echo tema ?>/css_files/bootstrap.min.css" crossorigin="anonymous">
    ...
    <style type="text/css">
        ...
        #master-indexbigbg {
            color: #fff;
            background: url(https://i.imgur.com/PKUmRBd.png) no-repeat center;
        }
    ...
    <script src="<?php echo url ?>/structure/files/tema/<?php echo tema ?>/css_files/popper.min.js" crossorigin="anonymous"></script>
    <script src="<?php echo url ?>/structure/files/tema/<?php echo tema ?>/css_files/bootstrap.min.js" crossorigin="anonymous"></script>
    <script>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card" id="master-indexbigbg">
                            ...
                            <img src="<?php echo url ?>/structure/files/tema/<?php echo tema ?>/css_files/wUAZubl.gif" style="position: absolute; right: -15px;bottom: -6px;">
                        </div>
                    </div>
                    <div class="col-md-12">
    ...
    <div style="font-weight: 14px;background: #1e262c; padding: 10px;border-top: 4px solid #1b2228;margin-top: 30px">
        <div class="container">
            ...
            <span style="color:#a7a7a7">
                ...
                <a href="/register">Criar uma conta no Habbo Pirata</a> |    <a href="/habbo-pirata">O que é Habbo Pirata?</a> |    <a href="/staff">Equipe Habbo</a> |  <a href="/noticia?=3">Últimas notícias</a> | <a href="/discord">Junte-se a nosso Discord</a> | 
