...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo url ?>/tema/<?php echo tema ?>/game/hotel.css">
     <link rel="stylesheet" type="text/css" href="<?php echo url ?>/tema/<?php echo tema ?>/game/flashalerta.css">
    <script type="text/javascript" src="//code.jquery.com/jquery-1.11.0.min.js"></script>
    <script type="text/javascript" src="<?php echo url ?>/tema/<?php echo tema ?>/game/object.js"></script>
    ...
    <script type="text/javascript" src="<?php echo url ?>/tema/<?php echo tema ?>/game/hotel.js"></script>
